  ...
  describe('availability status', () => {
    ...
    describe('availabilityFormatter', () => {
      it('returns OK text', () => {
        ...
        expect(screen.getByText('Available', { exact: false, selector: '.pf-v5-c-label__content' })).toBeInTheDocument();
      });
      ...
      it('returns WARNING text', () => {
        ...
        expect(screen.getByText('Partially available', { exact: false, selector: '.pf-v5-c-label__content' })).toBeInTheDocument();
      });
      ...
      it('returns DANGER text', () => {
        ...
        expect(screen.getByText('Unavailable', { exact: false, selector: '.pf-v5-c-label__content' })).toBeInTheDocument();
      });
      ...
      it('returns in progress text', () => {
        ...
        expect(screen.getByText('In progress', { exact: false, selector: '.pf-v5-c-label__content' })).toBeInTheDocument();
        expect(screen.getByText('wrench icon')).toBeInTheDocument();
      });
      ...
      it('returns unknown by default', () => {
        ...
        expect(screen.getByText('Unknown', { exact: false, selector: '.pf-v5-c-label__content' })).toBeInTheDocument();
      });
      ...
      it('returns paused text', () => {
        ...
        expect(screen.getByText('Paused', { exact: false, selector: '.pf-v5-c-label__content' })).toBeInTheDocument();
        expect(screen.getByText('pause icon')).toBeInTheDocument();
      });
    });
