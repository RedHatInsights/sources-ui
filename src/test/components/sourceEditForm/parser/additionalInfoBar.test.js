...
describe('AdditionalInfoBar', () => {
  ...
  it('renders with no app', async () => {
    await act(async () => {
      wrapper = mount(componentWrapperIntl(<AdditionalInfoBar {...initialProps} />, store));
    });
    wrapper.update();
  ...
  it('renders with one app', async () => {
    initialProps = {
      ...initialProps,
      applications: [{ application_type_id: CATALOG_APP.id }],
    };
  ...
  it('renders with multiple apps', async () => {
    initialProps = {
      ...initialProps,
      applications: [{ application_type_id: CATALOG_APP.id }, { application_type_id: COSTMANAGEMENT_APP.id }],
    };
