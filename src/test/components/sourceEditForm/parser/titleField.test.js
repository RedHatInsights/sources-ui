...
describe('titleField', () => {
  ...
  it('no app, one auth', () => {
    ...
    expect(titleField(applications, sourceType, appTypes, intl, auths)).toEqual({
      name: 'edit-title',
  ...
  it('no app', () => {
    ...
    expect(titleField(applications, sourceType, appTypes, intl, emptyAuths)).toEqual({
      name: 'edit-title',
      Content: expect.any(Function),
      description: undefined,
      component: 'description',
  ...
  it('one app', () => {
    ...
    expect(titleField(applications, sourceType, appTypes, intl)).toEqual({
      name: 'edit-title',
      Content: expect.any(Function),
      description: undefined,
      component: 'description',
