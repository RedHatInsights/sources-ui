...
describe('editSourceModal - on submit', () => {
    ...
    it('submit values successfuly', async () => {
        ...
        expect(doLoadSourceForEdit.doLoadSourceForEdit).toHaveBeenCalledWith({ id: SOURCE.source.id });
    ...
    it('check app availablity status - unavailable source', async () => {
        ...
        getAppStatus.checkAppAvailability = jest.fn().mockImplementation(() => Promise.resolve({
    ...
    it('check app availablity status - multiple apps - unavailable source', async () => {
        ...
        getAppStatus.checkAppAvailability = jest.fn()
