...
describe('Cost Management Google steps components', () => {
  ...
  describe('Assign access', () => {
    ...
    it('catches errors', async () => {
      ...
      expect(wrapper.find(ClipboardCopy).props().children).toEqual(
  ...
  it('Dataset', () => {
    ...
    expect(wrapper.find(TextListItem).first().text()).toEqual(
      'In the BigQuery console, select your project (some-project-id) from the navigation menu.'
    );
  });
