...
import type LegacyField from '@data-driven-forms/react-form-renderer/common-types/field';
...
const buildFormStory = (schema: { fields: LegacyField[] }, overrides?: Record<string, unknown>) => (
  <FormRenderer
