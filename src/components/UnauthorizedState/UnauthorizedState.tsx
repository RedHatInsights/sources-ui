    ...
    [COMMUNICATIONS]: {
      ...
      items: [
        ...
        },
        {
          ...
          href: 'https://docs.redhat.com/en/documentation/red_hat_hybrid_cloud_console/1-latest/extend-set_up_microsoft_teams_integration',
        },
        {
          name: intl.formatMessage({
          ...
          href: 'https://docs.redhat.com/en/documentation/red_hat_hybrid_cloud_console/1-latest/extend-set_up_google_chat_integration',
        },
      ],
    },
    [REPORTING]: {
      ...
      items: [
        {
          ...
          href: 'https://docs.redhat.com/en/documentation/red_hat_hybrid_cloud_console/1-latest/extend-configure_eda_integration',
        },
        {
          name: intl.formatMessage({
          ...
          href: 'https://docs.redhat.com/en/documentation/red_hat_hybrid_cloud_console/1-latest/extend-configure_servicenow_integration',
        },
        {
          name: intl.formatMessage({
          ...
          href: 'https://docs.redhat.com/en/documentation/red_hat_hybrid_cloud_console/1-latest/extend-configure_splunk_integration',
        },
      ],
    },
    [WEBHOOKS]: {
      ...
      description: (
        <>
          ...
          <a
            href="https://docs.redhat.com/en/documentation/red_hat_hybrid_cloud_console/1-latest/extend-integrate_other_apps_with_webhooks"
            target="_blank"
